 ...
 * 版 本：1.0
 * <p>
 * 创建日期：2016/4/20 16:13
 * <p>
 * 描 述：向右滑动关闭Activity
 * 在BaseActivity中oncreate方法
...
public class SwipeBackLayout extends FrameLayout {
    ...
    private CloseMode mode = CloseMode.FINISH;
    ...
    public void setSlideMode(SlideMode mSlideMode) {
        this.mSlideMode = mSlideMode;
    }

    private SlideMode mSlideMode = SlideMode.LEFT;
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mShadowDrawable = getResources().getDrawable(ResourceUtils.getResourceIdByName(context, "drawable", "customui_sb_shadow_left"));
    }
