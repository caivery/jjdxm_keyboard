...
//    protected AnimatorSet mPlayByOutAnimatorSet;
    ...
    public EmoticonsIndicatorView(Context context, AttributeSet attrs) {
        ...
        mBmpSelect = BitmapFactory.decodeResource(getResources(), ResourceUtils.getResourceIdByName(context, "drawable", "jjdxm_keyboard_indicator_point_select"));
        mBmpNomal = BitmapFactory.decodeResource(getResources(), ResourceUtils.getResourceIdByName(context, "drawable", "jjdxm_keyboard_indicator_point_nomal"));
