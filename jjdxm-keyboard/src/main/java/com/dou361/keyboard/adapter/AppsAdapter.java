...
public class AppsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(ResourceUtils.getResourceIdByName(mContext, "layout", "customui_item_app"), null);
            viewHolder.iv_icon = (ImageView) convertView.findViewById(ResourceUtils.getResourceIdByName(mContext, "id", "iv_icon"));
            viewHolder.tv_name = (TextView) convertView.findViewById(ResourceUtils.getResourceIdByName(mContext, "id", "tv_name"));
